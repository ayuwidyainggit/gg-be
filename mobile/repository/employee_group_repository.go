...
type EmpGroupRepository interface {
	...
	FindAllByCustId(dataFilter entity.GeneralQueryFilter) (empGroup []model.EmpGroup, total int64, lastPage int, err error)
	FindAllByCustIdLookupMode(dataFilter entity.GeneralQueryFilter) (empGroup []model.EmpGroup, total int64, lastPage int, err error)
	EmpTypeFindAllByCustId(dataFilter entity.GeneralQueryFilter, custId string) (empGroup []model.EmpType, total int64, lastPage int, err error)
...
func (repository *EmpGroupRepositoryImpl) EmpTypeFindAllByCustId(dataFilter entity.GeneralQueryFilter, custId string) ([]model.EmpType, int64, int, error) {
...
func (repository *EmpGroupRepositoryImpl) FindAllByCustIdLookupMode(dataFilter entity.GeneralQueryFilter) ([]model.EmpGroup, int64, int, error) {
...
func (repository *EmpGroupRepositoryImpl) FindAllByCustId(dataFilter entity.GeneralQueryFilter) ([]model.EmpGroup, int64, int, error) {
