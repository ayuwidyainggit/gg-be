...
type MCustomer struct {
	...
	DistributorAddress string         `gorm:"column:distributor_address" json:"distributor_address"`
}

func (m *MCustomer) BeforeCreate(trx *gorm.DB) (err error) {

	return nil
}

func (m *MCustomer) BeforeUpdate(trx *gorm.DB) (err error) {
