...
type Product struct {
	...
	Price1Minimum  float64 `json:"price1_minimum" gorm:"column:price1_minimum"`
	Price2Minimum  float64 `json:"price2_minimum" gorm:"column:price2_minimum"`
	Price3Minimum  float64 `json:"price3_minimum" gorm:"column:price3_minimum"`
	Price4Minimum  float64 `json:"price4_minimum" gorm:"column:price4_minimum"`
	Price5Minimum  float64 `json:"price5_minimum" gorm:"column:price5_minimum"`
	LimitAction    int     `json:"limit_action" gorm:"column:limit_action"`
	StatusMMP      int     `json:"status_manage_minimum_price_name" gorm:"column:status_manage_minimum_price_name"`
}
