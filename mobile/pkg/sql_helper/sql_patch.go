...
// ParseSort handles "field:order" patterns.
// It returns the field and "asc" if specified; otherwise, it defaults to "desc".
func ParseSort(input string) (string, string) {
