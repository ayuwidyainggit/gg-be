...
type CreateBpprBody struct {
	CustID         string    `json:"cust_id"`
	BpprNo         string    `json:"bppr_no"`
	BpprDate       *string   `json:"bppr_date" validate:""`
	...
	CreatedBy      int64     `json:"created_by"`
	UpdatedBy      int64     `json:"updated_by"`
	Details        []BpprDet `json:"details" validate:"required,dive"`
}

type UpdateBpprRequest struct {
	CustID         string                 `json:"cust_id"`
	ParentCustID   string                 `json:"parent_cust_id"`
	TrCode         string                 `json:"tr_code" validate:"required_if=DataStatus 2,omitempty,len=3"`
	BpprDate       *string                `json:"bppr_date" validate:""`
	BpprNo         *string                `json:"bppr_no"`
	ReturnReasonID int64                  `json:"return_reason_id" validate:"required_if=DataStatus 2"`
	ReturnNo       *string                `json:"return_no"`
	ReturnDate     *string                `json:"return_date"`
	Notes          *string                `json:"notes"`
	TotEmbInc      *float64               `json:"tot_emb_inc"`
	...
	VatBg          *float64               `json:"vat_bg"`
	VatBgValue     *float64               `json:"vat_bg_value"`
	DataStatus     int64                  `json:"data_status" validate:"oneof='1' '2'"`
	UpdatedBy      int64                  `json:"updated_by"`
	Details        []BpprDetUpdateRequest `json:"details"`
}

type ReturnBpprRequest struct {
	CustID         string                 `json:"cust_id"`
	ParentCustID   string                 `json:"parent_cust_id"`
	ReturnReasonID *int64                 `json:"return_reason_id"`
	ReturnNo       *string                `json:"return_no"`
