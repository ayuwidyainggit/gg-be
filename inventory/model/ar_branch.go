...
type ArBranchList struct {
	...
	ParentCustName    *string    `gorm:"column:parent_cust_name" json:"parent_cust_name"`
	// InvoiceStatus     *int64     `gorm:"column:invoice_status" json:"invoice_status"`
	// InvoiceStatusName *string    `gorm:"column:invoice_status_name" json:"invoice_status_name"`
}

func (ArBranchList) TableName() string {
	return "inv.gr_branch"
}

type ArBranchRead struct {
	CustID               string     `gorm:"column:cust_id" json:"cust_id"`
	CustName             string     `gorm:"column:cust_name" json:"cust_name"`
	GrBranchNo           string     `gorm:"column:gr_branch_no" json:"gr_branch_no"`
	GrBranchDate         *time.Time `gorm:"column:gr_branch_date" json:"gr_branch_date"`
...
func (ArBranchRead) TableName() string {
	return "inv.gr_branch"
}
...
type ArBranchDistributor struct {
	CustId   *string `gorm:"column:cust_id" json:"cust_id"`
	CustName *string `gorm:"column:cust_name" json:"cust_name"`
}

func (ArBranchDistributor) TableName() string {
	return "inv.gr_branch"
}

type ArBranchSupplier struct {
	SupId   *int64  `gorm:"column:sup_id" json:"sup_id"`
	SupCode *string `gorm:"column:sup_code" json:"sup_code"`
	SupName *string `gorm:"column:sup_name" json:"sup_name"`
}

func (ArBranchSupplier) TableName() string {
	return "inv.gr_branch"
}
