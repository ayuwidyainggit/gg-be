...
type BpprDet struct {
	ID         int64      `gorm:"column:bppr_det_id;primaryKey" json:"bppr_det_id"`
...
func (BpprDet) TableName() string {
	return "inv.bppr_det"
}

type BpprDetRead struct {
	ID         int        `gorm:"column:bppr_det_id;primaryKey" json:"bppr_det_id"`
	CustID     string     `gorm:"column:cust_id" json:"cust_id"`
	BpprNo     string     `gorm:"column:bppr_no" json:"bppr_no"`
	SeqNo      int        `gorm:"column:seq_no" json:"seq_no"`
	ProID      int        `gorm:"column:pro_id" json:"pro_id"`
...
func (BpprDetRead) TableName() string {
	return "inv.bppr_det"
}
