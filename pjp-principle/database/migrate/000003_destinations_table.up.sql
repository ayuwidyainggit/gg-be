CREATE TABLE IF NOT EXISTS pjp_principles.destinations (
    ...
    CONSTRAINT fk_destinations_pjp_principles FOREIGN KEY (pjp_id) REFERENCES pjp_principles.permanent_journey_plans(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_destinations_routes FOREIGN KEY (route_code) REFERENCES pjp_principles.routes(route_code) ON DELETE CASCADE ON UPDATE CASCADE
);
