...
func (repo *destinationRepository) GetAllEnhance(ctx context.Context, tx *gorm.DB, page, limit int, filters map[string]interface{}, currentCustomerId string) ([]model.Pjp, int) {
	var pjp []model.Pjp
