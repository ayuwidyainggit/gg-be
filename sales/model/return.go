...
type ReturnRead struct {
	...
	SalesmanCode  *string    `gorm:"column:salesman_code" json:"salesman_code"`
	SalesmanName  *string    `gorm:"column:salesman_name" json:"salesman_name"`
	EmployeeID    *int64     `gorm:"column:emp_id" json:"emp_id"`
	...
	DiscValue     *float64   `gorm:"column:disc_value" json:"disc_value"`
	PromoValue    *float64   `gorm:"column:promo_value" json:"promo_value"`
	PromoBgValue  *float64   `gorm:"column:promo_bg_value" json:"promo_bg_value"`
	Vat           *float64   `gorm:"column:vat" json:"vat"`
	VatValue      *float64   `gorm:"column:vat_value" json:"vat_value"`
	SubTotal      *float64   `gorm:"column:sub_total" json:"sub_total"`
	Total         *float64   `gorm:"column:total" json:"total"`
...
type EmpGroupsFilter struct {
	...
	UpdatedByName *string    `gorm:"column:updated_by_name" json:"updated_by_name,omitempty"`
	DeletedBy     *int64     `gorm:"column:deleted_by" json:"deleted_by,omitempty"`
	DeletedAt     *time.Time `gorm:"column:deleted_at" json:"deleted_at,omitempty"`
}

func (EmpGroupsFilter) TableName() string {
...
type Employee struct {
	...
	SubDistrictId *string    `gorm:"column:sub_district_id" json:"sub_district_id"`
	SubDistrict   *string    `gorm:"column:sub_district" json:"sub_district"`
	WardId        *string    `gorm:"column:ward_id" json:"ward_id"`
	...
	IsWaNo        bool       `gorm:"column:is_wa_no" json:"is_wa_no"`
...
type SalesmanCanvasRead struct {
	CustId        string          `gorm:"column:cust_id" json:"cust_id"`
...
func (SalesmanCanvasRead) TableName() string {
