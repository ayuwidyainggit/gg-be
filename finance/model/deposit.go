...
type DepositNumberList struct {
	DepositNo   string     `gorm:"column:deposit_no" json:"deposit_no"`
	CollectorID int        `gorm:"column:collector_id" json:"collector_id"`
...
type DepositDetail struct {
	...
	Notes            string  `gorm:"column:notes;type:varchar(30);default:''" json:"notes"`
}
...
type DepositExpense struct {
	DepositExpenseID int64           `gorm:"column:deposit_expense_id;primaryKey;autoIncrement" json:"deposit_expense_id"`
	DepositNo        string          `gorm:"column:deposit_no;type:varchar(30);not null" json:"deposit_no"`
	CustID           string          `gorm:"column:cust_id;type:varchar(10)" json:"cust_id"`
	ExpenseID        int64           `gorm:"column:expense_id;not null" json:"expense_id"`
	PaymentAmount    decimal.Decimal `gorm:"column:payment_amount;type:numeric(20,4);not null" json:"payment_amount"`
	...
	IsDel *bool `gorm:"column:is_del" json:"is_del,omitempty"`

	// Relation source
	DocNo   string  `gorm:"->;column:doc_no" json:"doc_no,omitempty"`
	Balance float64 `gorm:"->;column:balance" json:"balance,omitempty"`
}

func (DepositExpense) TableName() string {
	return "acf.deposit_expense"
}
