...
type DistPriceGroupUpdate struct {
	DistPriceGrpCode *string    `json:"dist_price_grp_code,omitempty" sql:"dist_price_grp_code"`
	DistPriceGrpName *string    `json:"dist_price_grp_name,omitempty" sql:"dist_price_grp_name"`
