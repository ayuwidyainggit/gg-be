...
type EmpGroup struct {
	...
	EmpGroupId    int        `db:"emp_grp_id" json:"emp_grp_id"`
	EmpGroupCode  string     `db:"emp_grp_code" json:"emp_grp_code"`
	EmpGroupName  string     `db:"emp_grp_name" json:"emp_grp_name"`
...
type EmpGroupUpdate struct {
	EmpGroupCode *string    `json:"emp_grp_code,omitempty" sql:"emp_grp_code"`
	EmpGroupName *string    `json:"emp_grp_name,omitempty" sql:"emp_grp_name"`
