...
type ProductCat struct {
	...
	PCatId        int        `db:"pcat_id" json:"pcat_id"`
	PCatCode      string     `db:"pcat_code" json:"pcat_code"`
	PCatName      string     `db:"pcat_name" json:"pcat_name"`
...
type ProductCatUpdate struct {
	PCatCode  *string    `json:"pcat_code,omitempty" sql:"pcat_code"`
	PCatName  *string    `json:"pcat_name,omitempty" sql:"pcat_name"`
