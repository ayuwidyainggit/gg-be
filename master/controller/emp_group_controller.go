...
func (controller *EmpGroupController) EmpTypesList(c *fiber.Ctx) error {
	...
	if err := c.QueryParser(&dataFilter); err != nil {
		log.Println("EmpGroupController, EmpTypesList, query parser filter:", err.Error())
	}
	...
	if err != nil {
		log.Println("EmpGroupController, EmpTypesList, data, err:", err.Error())
...
func (controller *EmpGroupController) TypeDetail(c *fiber.Ctx) error {
	...
	if err := c.ParamsParser(&params); err != nil {
		log.Println("EmpGroupController, Detail, ParamsParser:", err.Error())
		responsePayload.Setmsg(err.Error())
		return c.Status(fiber.StatusUnprocessableEntity).JSON(responsePayload.GetRespPayload())
	}
	...
	if errs != nil {
		log.Println("EmpGroupController, Detail, ValidateStruct(params), errs:", errs)
	...
	if err != nil {
		log.Println("EmpGroupController, Detail, FindOneByEmpGroupId, err:", err.Error())
...
func (controller *EmpGroupController) List(c *fiber.Ctx) error {
	...
	if err := c.QueryParser(&dataFilter); err != nil {
		log.Println("EmpGroupController, List, query parser filter:", err.Error())
	}
	...
	case "lookup":
		...
		if err != nil {
			log.Println("EmpGroupController, LookupList, data, err:", err.Error())
			responsePayload.Setmsg(err.Error())
			return c.Status(fiber.StatusUnprocessableEntity).JSON(responsePayload.GetRespPayload())
		}
	default:
		...
		if err != nil {
			log.Println("EmpGroupController, List, data, err:", err.Error())
			responsePayload.Setmsg(err.Error())
			return c.Status(fiber.StatusUnprocessableEntity).JSON(responsePayload.GetRespPayload())
		}
	}
...
func (controller *EmpGroupController) Create(c *fiber.Ctx) error {
	...
	if err := c.BodyParser(&request); err != nil {
		log.Println("EmpGroupController, Create, BodyParser:", err.Error())
		responsePayload.Setmsg(err.Error())
		return c.Status(fiber.StatusUnprocessableEntity).JSON(responsePayload.GetRespPayload())
	}
	...
	if errs != nil {
		log.Println("EmpGroupController, Create, ValidateStruct, errs:", errs)
		responsePayload.Setmsg(fiber.ErrBadRequest.Message)
		responsePayload.Seterrors(errs)
		return c.Status(fiber.StatusBadRequest).JSON(responsePayload.GetRespPayload())
	}
	...
	if err != nil {
		log.Println("EmpGroupController, Create, Store, err:", err.Error())
		responsePayload.Setmsg(err.Error())
		return c.Status(fiber.StatusBadRequest).JSON(responsePayload.GetRespPayload())
	}
...
func (controller *EmpGroupController) Update(c *fiber.Ctx) error {
	...
	if err := c.ParamsParser(&params); err != nil {
		log.Println("EmpGroupController, Update, ParamsParser(params):", err.Error())
		responsePayload.Setmsg(err.Error())
		return c.Status(fiber.StatusUnprocessableEntity).JSON(responsePayload.GetRespPayload())
	}
	...
	errs := controller.validator.ValidateStruct(params, headerAcceptLang)
	if errs != nil {
		log.Println("EmpGroupController, Update, ValidateStruct(params), errs:", errs)
		responsePayload.Setmsg(fiber.ErrBadRequest.Message)
	...
	if err := c.BodyParser(&request); err != nil {
		log.Println("EmpGroupController, Update, BodyParser(request), err:", err.Error())
		responsePayload.Setmsg(fiber.ErrBadRequest.Message)
		return c.Status(fiber.StatusUnprocessableEntity).JSON(responsePayload.GetRespPayload())
	}
	...
	errs = controller.validator.ValidateStruct(request, headerAcceptLang)
	if errs != nil {
		log.Println("EmpGroupController, Update, ValidateStruct(request), errs:", errs)
		responsePayload.Setmsg(fiber.ErrBadRequest.Message)
		responsePayload.Seterrors(errs)
		return c.Status(fiber.StatusBadRequest).JSON(responsePayload.GetRespPayload())
	}
	...
	if err != nil {
		log.Println("EmpGroupController, Update, Service.Update, err:", err.Error())
		responsePayload.Setmsg(err.Error())
		return c.Status(fiber.StatusBadRequest).JSON(responsePayload.GetRespPayload())
	}
...
func (controller *EmpGroupController) Delete(c *fiber.Ctx) error {
	...
	if err := c.ParamsParser(&params); err != nil {
		log.Println("EmpGroupController, Delete, ParamsParser, err:", err.Error())
		responsePayload.Setmsg(err.Error())
		return c.Status(fiber.StatusUnprocessableEntity).JSON(responsePayload.GetRespPayload())
	}
	...
	errs := controller.validator.ValidateStruct(params, headerAcceptLang)
	if errs != nil {
		log.Println("EmpGroupController, Delete, ValidateStruct, errs:", errs)
		responsePayload.Setmsg(fiber.ErrBadRequest.Message)
		responsePayload.Seterrors(errs)
		return c.Status(fiber.StatusBadRequest).JSON(responsePayload.GetRespPayload())
	}
	...
	if err != nil {
		log.Println("EmpGroupController, Delete, Service.Delete, err:", err.Error())
		responsePayload.Setmsg(err.Error())
		return c.Status(fiber.StatusBadRequest).JSON(responsePayload.GetRespPayload())
	}
