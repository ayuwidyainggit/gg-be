...
type EmpGroupService interface {
	...
	List(entity.GeneralQueryFilter) (data []entity.EmpGroupResponse, total int, lastPage int, err error)
	LookupList(entity.GeneralQueryFilter) (data []entity.EmpGroupLookupResponse, total int, lastPage int, err error)
	EmpTypeList(entity.GeneralQueryFilter, string) (data []entity.EmpTypeResponse, total int, lastPage int, err error)
...
func (service *empGroupServiceImpl) EmpTypeList(dataFilter entity.GeneralQueryFilter, custId string) (data []entity.EmpTypeResponse, total int, lastPage int, err error) {
...
func (service *empGroupServiceImpl) List(dataFilter entity.GeneralQueryFilter) (data []entity.EmpGroupResponse, total int, lastPage int, err error) {
...
func (service *empGroupServiceImpl) LookupList(dataFilter entity.GeneralQueryFilter) (data []entity.EmpGroupLookupResponse, total int, lastPage int, err error) {
	var empGroups []model.EmpGroup
