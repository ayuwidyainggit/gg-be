...
type NewRouteBody struct {
	...
	OutletCode   string `validate:"required" json:"outlet_code"`
	PjpCode      string `validate:"required" json:"pjp_code"`
	PjpID        int    `validate:"required" json:"pjp_id"`
	RouteCode    int    `validate:"required" json:"route_code"`
...
type DeleteOutletRequest struct {
	RouteCode  int      `validate:"required" json:"route_code"`
	OutletCode []string `validate:"required,notEmptyStringSlice" json:"outlet_code"`
...
type Outlets struct {
	OutletID      int     `validate:"required" json:"outlet_id" example:"5"`
	OutletCode    string  `validate:"required" json:"outlet_code" example:"OUT 5"`
	OutletName    string  `validate:"required" json:"outlet_name" example:"Outlet okok"`
	...
	OutletStatus  int     `validate:"required" json:"outlet_status" example:"1"`
	OutletAddress string  `validate:"required" json:"outlet_address" example:"mampang"`
...
type Route struct {
	...
	OutletID      int    `validate:"required" json:"outlet_id"`
	OutletCode    string `validate:"required" json:"outlet_code"`
	OutletName    string `validate:"required" json:"outlet_name"`
	Longitude     string `validate:"required" json:"longitude"`
	Latitude      string `validate:"required" json:"latitude"`
	OutletStatus  int    `validate:"required" json:"outlet_status"`
	OutletAddress string `validate:"required" json:"outlet_address"`
}
