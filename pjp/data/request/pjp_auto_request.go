...
type OutletReq struct {
	...
	OutletAddress string `json:"outlet_address" example:"Semarang"`
	OutletCode    string `json:"outlet_code" example:"OUT10"`
	OutletID      int    `json:"outlet_id" example:"10"`
	OutletName    string `json:"outlet_name" example:"Outlet 10"`
	OutletStatus  int    `json:"outlet_status" example:"1"`
}
