...
// @Router			/web/approval-routes [get]
// @Security        Bearer
func (controller *routeController) FindAllApproval(ctx *gin.Context) {
	...
	responses, pagination, err := controller.routeService.GetAll(c, page, limit, filters, currentCustomerId)
	helper.ErrorPanic(err)
