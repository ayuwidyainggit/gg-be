...
// @Param			approval body request.UpdateStatusRequest true "update status approval with propose"
// @Produce			application/json
// @Tags			approval route
// @Success			200 {object} response.Response{}
// @Router			/web/approval-routes/status [patch]
// @Security        Bearer
func (controller *routeController) UpdateStatus(ctx *gin.Context) {
	...
	controller.routeService.UpdateStatus(c, Request, customerID)
