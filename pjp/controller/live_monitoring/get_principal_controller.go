...
// GetPrincipalMonitoring godoc
// @Summary     Get location monitoring data for Principal
// @Description Return list of employee location monitoring data for principal users
...
// @Router      /v1/live-monitoring-principal [get]
// @Security    Bearer
func (c *liveMonitoringController) GetPrincipalMonitoring(ctx *gin.Context) {
	...
	// Call service
	data, paging, err := c.service.GetPrincipalMonitoring(reqCtx, req, customerID)
	if err != nil {
