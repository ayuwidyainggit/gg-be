...
// @Security        Bearer
func (controller *thirdPartyController) GetOutletBySalesCodes(ctx *gin.Context) {
	...
	responses, pagination, err := controller.master.GetOutletBySalesCodes(c, dataFilter, headers, currentCustomerId)
