...
func (service *pjpService) GetPjpWithRoute(ctx context.Context, q string, custId string) []response.PjpResponse {
	...
	rows := service.pjpRepository.GetPjpWithRoute(ctx, tx, q, custId)
