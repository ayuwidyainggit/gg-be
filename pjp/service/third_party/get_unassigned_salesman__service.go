...
func (service *thirdPartyService) GetUnassignedSalesman(ctx context.Context, dataFilter request.SalesmanListQueryFilter, custId string) ([]model.NewSalesman, response.Meta) {
